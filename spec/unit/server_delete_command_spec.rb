...
describe Chef::Knife::Cloud::ServerDeleteCommand do
  ...
  it {expect {Chef::Knife::Cloud::ServerDeleteCommand.new}.to raise_error(ArgumentError, "wrong number of arguments (0 for 2)")}

  it {expect {@instance.run}.to raise_error(Chef::Exceptions::Override, "You must override exec_command in #{@instance.to_s} for server deletion.")}
